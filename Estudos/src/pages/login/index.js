...
export default function LoginScreen() {
    ...
    // const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjYWlvMjEzMkBnbWFpbC5jb20iLCJpc3MiOiJhaW1lIiwiZXhwIjoxNjk5MjM1MzY0fQ.d1nyEoMDaVKoVntAcyNuQ3dtkQJUsNkLvQWhuqDAKEw'
    ...
    const navigateToOtherScreen = () => {
      ...
      async function handleLogin() {
        try {
          const url = 'http://192.168.15.6:8080/api/clientes/login';
          ...
          if (response.status === 200) {
            ...
            navigation.navigate("Button", {email, senha});
